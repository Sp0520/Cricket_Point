...
<div class="admin-shell">
  ...
  <div class="flex-grow-1">
    <div class="d-flex flex-wrap justify-content-between align-items-end gap-3 mb-3">
      <div>
        <h2 class="fw-bold mb-1">Admin Leaderboard</h2>
        <div class="cp-muted">Same ranking as public leaderboard, with quick admin access.</div>
      </div>
      <form class="d-flex gap-2" method="get" action="<?= h(url_for('admin_leaderboard.php')) ?>">
          ...
          <tbody>
            ...
            <?php foreach ($rows as $r): ?>
              <tr>
                ...
                <td class="text-end">
                  <a class="btn btn-sm btn-outline-success" href="<?= h(url_for('player.php?id=' . (int)$r['id'])) ?>">Profile</a>
                  <a class="btn btn-sm btn-outline-light" href="<?= h(url_for('admin_players.php')) ?>">Edit player</a>
                </td>
              </tr>
            <?php endforeach; ?>
          </tbody>
